...
CategoryListingModel categoryListingModelFromJson(String str) => CategoryListingModel.fromJson(json.decode(str));

String categoryListingModelToJson(CategoryListingModel data) => json.encode(data.toJson());
