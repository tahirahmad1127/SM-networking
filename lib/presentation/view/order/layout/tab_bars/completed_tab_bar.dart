...
class CompletedTabBar extends StatefulWidget {
  const CompletedTabBar({super.key});

  @override
  State<CompletedTabBar> createState() => _CompletedTabBarState();
}

class _CompletedTabBarState extends State<CompletedTabBar>
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                return InkWell(
                  ...
                  child: OrderCard(status: 'Completed', model: order),
                );
              },
            );
