...
class InProgressTabBar extends StatefulWidget {
  const InProgressTabBar({super.key});

  @override
  State<InProgressTabBar> createState() => _InProgressTabBarState();
}

class _InProgressTabBarState extends State<InProgressTabBar>
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                return InkWell(
                  ...
                  child: OrderCard(status: 'Pending', model: order),
                );
              },
            );
