...
class AllOrdersTabBar extends StatefulWidget {
  const AllOrdersTabBar({super.key});

  @override
  State<AllOrdersTabBar> createState() => _AllOrdersTabBarState();
}

class _AllOrdersTabBarState extends State<AllOrdersTabBar>
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, i) {
                ...
                return InkWell(
                  ...
                  child: OrderCard(status: 'Processed', model: order),
                );
              },
            );
