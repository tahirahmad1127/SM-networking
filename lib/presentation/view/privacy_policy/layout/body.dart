...
import 'package:sm_networking/infrastructure/services/privacy_policy.dart';
...
import '../../../../application/setting_bloc/setting_bloc.dart';
import '../../../../infrastructure/model/privacy_policy.dart';
      ...
      child: BlocBuilder<SettingBloc, SettingState>(
        builder: (context, state) {
          if (state is SettingInitial) {
            BlocProvider.of<SettingBloc>(context).add(const GetPrivacyPolicyEvent());
            return const Center(
